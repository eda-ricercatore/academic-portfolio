...
Data analytics can help to reduce drop-out rates from the course, or lost interest in certain electrical/computer engineering (ECE) areas, if intervention strategies are implemented early on (before the midterm) to recognize early signs of students struggling in intermediate ECE courses (e.g., ECEN 475 on VLSI design).

1.ii)
Firstly, the sections of ECEN 475 are split into a control group and an experimental/treatment group.
