...
Data analytics can help to recognize and assist students with inadequate academic background for the course, if intervention strategies are implemented early on (before the midterm) to recognize early signs of students struggling in advanced computer science/engineering (CSE) courses (e.g., CSCE 676 on data mining).

1.ii)
Firstly, the students of CSCE 676 are split into a control group and an experimental/treatment group.
