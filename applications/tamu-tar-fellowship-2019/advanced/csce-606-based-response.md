...
Data analytics can help to recognize and assist students with inadequate academic background for the course, if intervention strategies are implemented early on (before the midterm) to recognize early signs of students struggling in advanced computer science/engineering (CSE) courses (e.g., CSCE 606 on software engineering).
